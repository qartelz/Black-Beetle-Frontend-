...
export default function PTC() {
    ...
    return <div className="flex-1 flex bg-[#D8D8D8]">
        <div className="flex-1 px-10 md:px-20 lg:px-40 py-10 flex flex-col relative">
            ...
            <div className="w-full flex flex-col md:flex-row items-center gap-x-10">
                ...
                <button className="w-full my-4 md:my-0 md:-mb-5 md:w-fit py-3 end-0 bg-[#D7B257] text-black px-8 rounded-lg font-semibold hover:bg-[#cfa63d] active:bg-[#ffbe18] transition-all duration-100 ease-in-out">
                    Continue
                </button>
            </div>

            <div className="md:mt-5 flex items-center bg-[#FFFFFF53] border-[#D7B257] text-black rounded-lg px-4 py-2 border shadow-lg">
                <Search className="text-black cursor-pointer lg:cursor-default " onClick={() => setOpenSearchBar(true)} />
                <input
                    type="text"
                    placeholder="Search Stocks..."
                    className="ml-2 w-full text-black outline-none bg-transparent py-1"
                />
            </div>
