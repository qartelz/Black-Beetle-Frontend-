import { LucideArrowLeft, LucideArrowRight, LucideChartLine, LucideDiamond, LucidePackage, LucidePackageCheck, LucidePersonStanding, LucideTrendingDown, LucideTrendingUp } from "lucide-react";
        ...
        <div className="grid grid-cols-3 gap-5 mt-4">
            ...
            <div className="bg-primary text-white p-5 rounded-lg flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <span>Users canceled orders</span>
                </div>
            </div>
            <div className="bg-primary text-white p-5 rounded-lg flex items-center justify-center">
                <div className="flex flex-col items-center">
                    <div className="w-24 h-24 rounded-full border border-[#D7B257] text-[#D7B257] flex items-center justify-center">
                        <LucidePackageCheck size={40} />
                    </div>
                    <span className="text-3xl font-bold mt-2">100</span>
