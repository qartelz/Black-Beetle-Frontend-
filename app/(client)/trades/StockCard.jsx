...
export default function StockCard({ stockData }) {
    return (
        <Link href={`/stock/${stockData.symbol}`} className="stock-card bg-gradient-stock-card rounded-[30px] border-[#C58F0A] p-4 shadow-lg border-4 flex items-center relative">
